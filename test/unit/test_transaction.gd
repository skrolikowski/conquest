...
##
## Transaction is now a RefCounted object, so no manual memory management needed.
##
...
func test_clone_creates_independent_copy() -> void:
	# Arrange
	var original:Transaction = Transaction.new()
...
func test_add_transaction_merges_resources() -> void:
	# Arrange
	var transaction1:Transaction = Transaction.new()
	...
	var transaction2:Transaction = Transaction.new()
...
func test_building_cost_transaction() -> void:
	...
	var cost:Transaction = Transaction.new()
	cost.add_resources({
		"wood": 10,
		"crops": 5
	})
...
func test_production_calculation() -> void:
	...
	var consumption:Transaction = Transaction.new()
...
func test_resource_transfer_between_entities() -> void:
	...
	var settler_resources:Transaction = Transaction.new()
	...
	var colony_resources:Transaction = Transaction.new()
